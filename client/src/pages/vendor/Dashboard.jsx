...
const s = {
  page: { maxWidth: '960px' },
  greeting: { fontSize: '1.4rem', fontWeight: 700, color: '#1a1a2e', marginBottom: '1rem' },
  statsRow: { display: 'flex', gap: '0.75rem', marginBottom: '1.5rem' },
  statCard: { flex: 1, background: '#fff', borderRadius: '14px', padding: '1rem 1.1rem', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', border: '1px solid #f3f4f6', transition: 'transform 0.2s ease, box-shadow 0.2s ease', cursor: 'default' },
  statIcon: { marginBottom: '0.3rem' },
  statLabel: { fontSize: '0.7rem', fontWeight: 500, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '0.2rem' },
  statValue: { fontSize: '1.5rem', fontWeight: 800, color: '#1a1a2e' },
  sectionHeading: { fontSize: '1.05rem', fontWeight: 700, color: '#1a1a2e', marginBottom: '0.6rem' },
  tableWrap: { background: '#fff', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', border: '1px solid #f3f4f6', marginBottom: '1.5rem' },
